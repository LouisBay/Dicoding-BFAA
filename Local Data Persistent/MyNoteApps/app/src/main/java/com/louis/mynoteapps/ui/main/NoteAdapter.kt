...
import com.louis.mynoteapps.databinding.ItemNoteBinding
import com.louis.mynoteapps.helper.NoteDiffCallback
...
class NoteAdapter : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>(){
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        Log.d(this::class.java.name, "List : ${this.listNotes}")
    }
        ...
        fun bind(note: Note) {
            binding.apply {
                ...
                cvItemNote.setOnClickListener {
                    Intent(it.context, NoteAddUpdateActivity::class.java).apply {
